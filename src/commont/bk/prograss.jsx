...
import { Table, Button, DatePicker, Modal, Radio, Pagination, message, Input } from 'antd';
    ...
    render() {
        const columns = [
            ...
            },
            {
                ...
                render: (text) => (
                    <span>
                        {text.check_status === '-1' ? <Button type="primary" onClick={() => this.showModal(text.id, text.file, text.course_id)}>审核课件</Button> : ''}
                    </span>
                ),
            },
        ];
